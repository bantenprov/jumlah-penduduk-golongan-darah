...
class CreateJPGolonganDarahTable extends Migration {

	public function up()
	{
		Schema::create('jumlah_penduduk_golongan_darahs', function(Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::drop('jumlah_penduduk_golongan_darahs');
	}
}